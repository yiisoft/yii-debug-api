...
namespace Yiisoft\Yii\Debug\Api\Panel;
...
use Yiisoft\Yii\Debug\Api\Controller\UserController;
use Yiisoft\Yii\Debug\Api\Panel;
...
class UserPanel extends Panel
{
    ...
    public function init(): void
    {
        ...
        if (!is_object($this->filterModel)
            ...
            && in_array(\Yiisoft\Yii\Debug\Api\Models\Search\UserSearchInterface::class, class_implements($this->filterModel), true)
        ) {
            ...
            if (is_subclass_of($this->getUser()->identityClass, ActiveRecord::class)) {
                $this->filterModel = new \Yiisoft\Yii\Debug\Api\Models\Search\User();
            }
        }
    }
